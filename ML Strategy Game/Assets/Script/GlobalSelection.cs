...
public class GlobalSelection : MonoBehaviour
{
    ...
    SelectedDictionary selectedDir;
    RaycastHit hit;
    ...
    void Start()
    {
        selectedDir = GetComponent<SelectedDictionary>();
        dragSelect = false;
    }
        ...
        if (Input.GetMouseButtonUp(0))
        {
            if (dragSelect == false)
            {
                ...
                if (Physics.Raycast(ray, out hit, 50000.0f))
                {
                    ...
                    {
                        selectedDir.addSelected(hit.transform.gameObject);
                    }
                    else
                    {
                        selectedDir.deselectAll();
                        selectedDir.addSelected(hit.transform.gameObject); 
                    }
                }
                else
    ...
    {
        selectedDir.addSelected(other.gameObject);
    }
}
